...
public class Rules extends JFrame implements ActionListener{
    ...
    Rules(String username){
        ...
        setBounds(600, 200, 800, 650); //USED TO SET ON SCREEN
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        JLabel l1 = new JLabel("Welcome " + username + " to Simple Minds");
        l1.setForeground(new Color(30, 144, 255)); //to change color of font;
        ...
        b1 = new JButton("Back"); //button on frame
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            this.setVisible(false); // to close current frame
            new SimpleMinds1().setVisible(true);
